...
INSERT INTO `f32ee`.`MOVIE` (`movie_id`, `movie_name`, `duration`, `language`, `genre`, `distributor`, `release_date`, `image_dir`, `synopsis`, `rating`, `cast`, `director`) VALUES 
...
'CSR', 
'2021-10-05', 
'posters_small\\007.jpg', 
'In No Time To Die, Bond has left active service and is enjoying a tranquil life in Jamaica. His peace is short-lived when his old friend Felix Leiter from the CIA turns up asking for help. The mission to rescue a kidnapped scientist turns out to be far more treacherous than expected, leading Bond onto the trail of a mysterious villain armed with dangerous new technology.',
'M16 - some violence',
'Daniel Craig, Rami Malek, Lea Seydoux, Lashana Lynch, Ben Whishaw, Naomie Harris',
'Cary Joji Fukunaga'
),
...
'WB', 
'2021-09-16', 
'posters_small\\dune.webp', 
'A mythic and emotionally charged hero''s journey, Dune tells the story of Paul Atreides, a brilliant and gifted young man born into a great destiny beyond his understanding, who must travel to the most dangerous planet in the universe to ensure the future of his family and his people. As malevolent forces explode into conflict over the planet''s exclusive supply of the most precious resource in existence-a commodity capable of unlocking humanity''s greatest potential-only those who can conquer their fear will survive.',
'PG - coarse language',
'Timothee Chalamet, Rebecca Ferguson, Oscar Isaac, Josh Brolin, Stellan Skarsgard, Dave Bautista',
'Denis Villeneuve'
),
...
(NULL,
'ShangChi and The Legend of Ten Rings', 
'112', 
'ENG', 
'Action', 
'WDS', 
'2021-09-01', 
'posters_small\\shangchi_small.webp', 
'Marvel Studios: Shang-Chi and The Legend of The Ten Rings stars Simu Liu as Shang-Chi, who must confront the past he thought he left behind when he is drawn into the web of the mysterious Ten Rings organization. The film also stars Tony Leung as Wenwu, Awkwafina as Shang-Chi''s friend Katy and Michelle Yeoh as Jiang Nan, as well as Fala Chen, Meng''er Zhang, Florian Munteanu and Ronny Chieng.',
'PG - mild violence',
'Simu Liu, Tony Leung, Awkwafina, Michelle Yeoh, Fala Chen, Meng''er Zhang, Florian Munteanu, Ronny Chieng',
...
'WDS', 
'2021-10-28', 
'posters_small\\antlers.jpg', 
'"ANTLERS contains several sequences with flashing lights that may affect those who are susceptible to photosensitive epilepsy or have other photosensitivities."<br>
...
'M16 - blood and gore',
'Keri Russell, Jeremy T. Thomas, Jesse Plemons, Graham Greene',
'Scott Cooper'
),
...
'GVP', 
'2021-10-28', 
'posters_small\\Late Night Ride.jpg', 
'A group of social media influencers, led by Nat, decides to explore a haunted road and nearby cycling park, in an attempt to gain more viewers for their channel. Nat purposely breaks some taboo in the hopes of capturing paranormal activities and ends up being haunted. What will happen to her? Jie lost his wife in a car accident and his son, Josh, has not spoken since. The father and son end up on a late-night bus ride where all dark secrets will be unveiled. Min is a private hire driver who works day and night to earn money for her father''s medical bills. Sinister happenings started to occur when she is on the roads and she needs to figure out why before the situation gets out of control.',
'M18 - violence',
'Lina Ng, Andie Chen, Jayley Woo',
'Koh Chong Wu'
),
...
'SJR', 
'2021-11-14', 
'posters_small\\tokyorevengers.webp', 
'This is my life''s revenge! A down-and-out youth stands up to power to save the only girl he has ever loved.
 ...
 Manji gang!',
 'PG - coarse language',
 'Takumi Kitamura, Yuki Yamada, Yosuke Sugino, Mio Imada, Nobuyuki Suzuki, Gordon Maeda, Hiroya Shimizu, Hayato Isomura, Shotaro Mamiya, Ryo Yoshizawa',
 'Tsutomu Hanabusa'
 ),
...
'GVP', 
'2021-10-21', 
'posters_small\\cloudyMountain.jpg', 
